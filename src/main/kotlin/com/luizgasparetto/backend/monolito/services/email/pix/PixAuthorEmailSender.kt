...
/**
 * Responsável por enviar email para autor quando Pix é confirmado
 */
@Component
class PixAuthorEmailSender(
    ...
    fun send(order: Order) {
        val subject = "📦 Novo pedido pago (#${order.id}) — $brandName"
              ...
              <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                <tr>
                  ...
                  <td style="text-align:right;vertical-align:middle;">
                    ...
                    <div style="opacity:.9;font-size:14px;line-height:1.2;margin-top:4px;">Novo pedido pago</div>
                  </td>
                </tr>
              </table>
            </div>
